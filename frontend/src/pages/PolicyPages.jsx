...
<h1 className="text-4xl font-bold mb-6 mt-12 text-center lg:text-5xl py-12 lg:mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500">
          Privacy Policy
                ...
                <section className="mb-8">
                    <h2 className="text-3xl font-semibold mb-4 text-gray-800">4. How We Share Your Information</h2>
                    <ul className="list-disc pl-6 text-lg text-gray-600 space-y-2">
                ...
                <section className="mb-8">
                    <h2 className="text-3xl font-semibold mb-4 text-gray-800">5. Data Security</h2>
                    <p className="text-lg text-gray-600 leading-relaxed">
                ...
                <section className="mb-8">
                    <h2 className="text-3xl font-semibold mb-4 text-gray-800">6. Your Rights</h2>
                    <ul className="list-disc pl-6 text-lg text-gray-600 space-y-2">
                ...
                <section className="mb-8">
                    <h2 className="text-3xl font-semibold mb-4 text-gray-800">7. Third-Party Links</h2>
                    <p className="text-lg text-gray-600 leading-relaxed">
                ...
                <section className="mb-8">
                    <h2 className="text-3xl font-semibold mb-4 text-gray-800">8. Changes to This Privacy Policy</h2>
                    <p className="text-lg text-gray-600 leading-relaxed">
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-none pl-0 text-lg text-gray-600 space-y-1">
                        <li>Email: <a href="mailto:info.efent@gmail.com" className="text-purple-600 hover:text-pink-500 underline">info.efent@gmail.com</a></li>
                        <li>Phone: <a href="tel:+917875717213" className="text-purple-600 hover:text-pink-500 underline">+91 7875717213</a></li>
                        <li>WhatsApp: <a href="https://wa.me/917875717213" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-pink-500 underline">Chat with us</a></li>
                    </ul>
                </section>

                <section className="mb-8">
                    <h2 className="text-3xl font-semibold mb-4 text-gray-800">10. Terms of Service</h2>
                    <p className="text-lg text-gray-600 leading-relaxed">
                        Your use of our Site is also governed by our Terms of Service, which can be found <a href="[Insert Link]" className="text-orange-500 hover:text-pink-500 underline">here</a>.
                    </p>
                </section>
            </motion.div>
            <Footer />

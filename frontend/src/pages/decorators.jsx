          ...
          {vendors.map((vendor) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Button className="w-full py-3 px-6 rounded-lg bg-gradient-to-r from-indigo-400 to-pink-400 text-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-pink-500 transition duration-300">
  Send Enquiry
</Button>
<Button className="w-full py-3 px-6 rounded-lg bg-gradient-to-r from-indigo-400 to-pink-400 text-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-pink-500 transition duration-300">
  View Contact
